...
[Skip to main content](https://docs.openclaw.ai/cli)
...
-   [Command pages](https://docs.openclaw.ai/cli)
-   [Global flags](https://docs.openclaw.ai/cli)
-   [Output styling](https://docs.openclaw.ai/cli)
-   [Color palette](https://docs.openclaw.ai/cli)
-   [Command tree](https://docs.openclaw.ai/cli)
-   [Security](https://docs.openclaw.ai/cli)
-   [Secrets](https://docs.openclaw.ai/cli)
-   [Plugins](https://docs.openclaw.ai/cli)
-   [Memory](https://docs.openclaw.ai/cli)
-   [Chat slash commands](https://docs.openclaw.ai/cli)
-   [Setup + onboarding](https://docs.openclaw.ai/cli)
-   [setup](https://docs.openclaw.ai/cli)
-   [onboard](https://docs.openclaw.ai/cli)
-   [configure](https://docs.openclaw.ai/cli)
-   [config](https://docs.openclaw.ai/cli)
-   [doctor](https://docs.openclaw.ai/cli)
-   [Channel helpers](https://docs.openclaw.ai/cli)
-   [channels](https://docs.openclaw.ai/cli)
-   [skills](https://docs.openclaw.ai/cli)
-   [pairing](https://docs.openclaw.ai/cli)
-   [devices](https://docs.openclaw.ai/cli)
-   [webhooks gmail](https://docs.openclaw.ai/cli)
-   [dns setup](https://docs.openclaw.ai/cli)
-   [Messaging + agent](https://docs.openclaw.ai/cli)
-   [message](https://docs.openclaw.ai/cli)
-   [agent](https://docs.openclaw.ai/cli)
-   [agents](https://docs.openclaw.ai/cli)
-   [agents list](https://docs.openclaw.ai/cli)
-   [agents add \[name\]](https://docs.openclaw.ai/cli)
-   [agents bindings](https://docs.openclaw.ai/cli)
-   [agents bind](https://docs.openclaw.ai/cli)
-   [agents unbind](https://docs.openclaw.ai/cli)
-   [agents delete <id>](https://docs.openclaw.ai/cli)
-   [acp](https://docs.openclaw.ai/cli)
-   [status](https://docs.openclaw.ai/cli)
-   [Usage tracking](https://docs.openclaw.ai/cli)
-   [health](https://docs.openclaw.ai/cli)
-   [sessions](https://docs.openclaw.ai/cli)
-   [Reset / Uninstall](https://docs.openclaw.ai/cli)
-   [reset](https://docs.openclaw.ai/cli)
-   [uninstall](https://docs.openclaw.ai/cli)
-   [Gateway](https://docs.openclaw.ai/cli)
-   [gateway](https://docs.openclaw.ai/cli)
-   [gateway service](https://docs.openclaw.ai/cli)
-   [logs](https://docs.openclaw.ai/cli)
-   [gateway <subcommand>](https://docs.openclaw.ai/cli)
-   [Models](https://docs.openclaw.ai/cli)
-   [models (root)](https://docs.openclaw.ai/cli)
-   [models list](https://docs.openclaw.ai/cli)
-   [models status](https://docs.openclaw.ai/cli)
-   [models set <model>](https://docs.openclaw.ai/cli)
-   [models set-image <model>](https://docs.openclaw.ai/cli)
-   [models aliases list|add|remove](https://docs.openclaw.ai/cli)
-   [models fallbacks list|add|remove|clear](https://docs.openclaw.ai/cli)
-   [models image-fallbacks list|add|remove|clear](https://docs.openclaw.ai/cli)
-   [models scan](https://docs.openclaw.ai/cli)
-   [models auth add|setup-token|paste-token](https://docs.openclaw.ai/cli)
-   [models auth order get|set|clear](https://docs.openclaw.ai/cli)
-   [System](https://docs.openclaw.ai/cli)
-   [system event](https://docs.openclaw.ai/cli)
-   [system heartbeat last|enable|disable](https://docs.openclaw.ai/cli)
-   [system presence](https://docs.openclaw.ai/cli)
-   [Cron](https://docs.openclaw.ai/cli)
-   [Node host](https://docs.openclaw.ai/cli)
-   [Nodes](https://docs.openclaw.ai/cli)
-   [Browser](https://docs.openclaw.ai/cli)
-   [Docs search](https://docs.openclaw.ai/cli)
-   [docs \[query...\]](https://docs.openclaw.ai/cli)
-   [TUI](https://docs.openclaw.ai/cli)
-   [tui](https://docs.openclaw.ai/cli)
...
-   `--workspace <dir>`: agent workspace path (default `~/.claude-lab/silvana`).
