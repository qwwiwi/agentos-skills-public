...
[Skip to main content](https://docs.openclaw.ai/cli/agents)
...
-   [Examples](https://docs.openclaw.ai/cli/agents)
-   [Routing bindings](https://docs.openclaw.ai/cli/agents)
-   [Binding scope behavior](https://docs.openclaw.ai/cli/agents)
-   [Identity files](https://docs.openclaw.ai/cli/agents)
-   [Set identity](https://docs.openclaw.ai/cli/agents)
...
-   Example path: `~/.claude-lab/silvana/IDENTITY.md`
