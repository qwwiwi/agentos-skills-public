...
[Skip to main content](https://docs.openclaw.ai/cli/setup)
...
-   [Examples](https://docs.openclaw.ai/cli/setup)
...
[sessions](https://docs.openclaw.ai/cli/sessions)[skills](https://docs.openclaw.ai/cli/skills)
