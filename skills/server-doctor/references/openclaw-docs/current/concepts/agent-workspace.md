...
-   If `OPENCLAW_PROFILE` is set and not `"default"`, the default becomes `~/.claude-lab/silvana-<profile>`.
...
1.  Clone the repo to the desired path (default `~/.claude-lab/silvana`).
