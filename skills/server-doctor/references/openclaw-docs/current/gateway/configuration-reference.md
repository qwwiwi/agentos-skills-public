...
[Skip to main content](https://docs.openclaw.ai/gateway/configuration-reference)
...
-   [Channels](https://docs.openclaw.ai/gateway/configuration-reference)
-   [DM and group access](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Channel model overrides](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Channel defaults and heartbeat](https://docs.openclaw.ai/gateway/configuration-reference)
-   [WhatsApp](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Telegram](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Discord](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Google Chat](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Slack](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Mattermost](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Signal](https://docs.openclaw.ai/gateway/configuration-reference)
-   [BlueBubbles](https://docs.openclaw.ai/gateway/configuration-reference)
-   [iMessage](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Microsoft Teams](https://docs.openclaw.ai/gateway/configuration-reference)
-   [IRC](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Multi-account (all channels)](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Other extension channels](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Group chat mention gating](https://docs.openclaw.ai/gateway/configuration-reference)
-   [DM history limits](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Self-chat mode](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Commands (chat command handling)](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Agent defaults](https://docs.openclaw.ai/gateway/configuration-reference)
-   [agents.defaults.workspace](https://docs.openclaw.ai/gateway/configuration-reference)
-   [agents.defaults.repoRoot](https://docs.openclaw.ai/gateway/configuration-reference)
-   [agents.defaults.skipBootstrap](https://docs.openclaw.ai/gateway/configuration-reference)
-   [agents.defaults.bootstrapMaxChars](https://docs.openclaw.ai/gateway/configuration-reference)
-   [agents.defaults.bootstrapTotalMaxChars](https://docs.openclaw.ai/gateway/configuration-reference)
-   [agents.defaults.bootstrapPromptTruncationWarning](https://docs.openclaw.ai/gateway/configuration-reference)
-   [agents.defaults.imageMaxDimensionPx](https://docs.openclaw.ai/gateway/configuration-reference)
-   [agents.defaults.userTimezone](https://docs.openclaw.ai/gateway/configuration-reference)
-   [agents.defaults.timeFormat](https://docs.openclaw.ai/gateway/configuration-reference)
-   [agents.defaults.model](https://docs.openclaw.ai/gateway/configuration-reference)
-   [agents.defaults.cliBackends](https://docs.openclaw.ai/gateway/configuration-reference)
-   [agents.defaults.heartbeat](https://docs.openclaw.ai/gateway/configuration-reference)
-   [agents.defaults.compaction](https://docs.openclaw.ai/gateway/configuration-reference)
-   [agents.defaults.contextPruning](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Block streaming](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Typing indicators](https://docs.openclaw.ai/gateway/configuration-reference)
-   [agents.defaults.sandbox](https://docs.openclaw.ai/gateway/configuration-reference)
-   [agents.list (per-agent overrides)](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Multi-agent routing](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Binding match fields](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Per-agent access profiles](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Session](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Messages](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Response prefix](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Ack reaction](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Inbound debounce](https://docs.openclaw.ai/gateway/configuration-reference)
-   [TTS (text-to-speech)](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Talk](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Tools](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Tool profiles](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Tool groups](https://docs.openclaw.ai/gateway/configuration-reference)
-   [tools.allow / tools.deny](https://docs.openclaw.ai/gateway/configuration-reference)
-   [tools.byProvider](https://docs.openclaw.ai/gateway/configuration-reference)
-   [tools.elevated](https://docs.openclaw.ai/gateway/configuration-reference)
-   [tools.exec](https://docs.openclaw.ai/gateway/configuration-reference)
-   [tools.loopDetection](https://docs.openclaw.ai/gateway/configuration-reference)
-   [tools.web](https://docs.openclaw.ai/gateway/configuration-reference)
-   [tools.media](https://docs.openclaw.ai/gateway/configuration-reference)
-   [tools.agentToAgent](https://docs.openclaw.ai/gateway/configuration-reference)
-   [tools.sessions](https://docs.openclaw.ai/gateway/configuration-reference)
-   [tools.sessions\_spawn](https://docs.openclaw.ai/gateway/configuration-reference)
-   [tools.subagents](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Custom providers and base URLs](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Provider field details](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Provider examples](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Skills](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Plugins](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Browser](https://docs.openclaw.ai/gateway/configuration-reference)
-   [UI](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Gateway](https://docs.openclaw.ai/gateway/configuration-reference)
-   [OpenAI-compatible endpoints](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Multi-instance isolation](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Hooks](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Gmail integration](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Canvas host](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Discovery](https://docs.openclaw.ai/gateway/configuration-reference)
-   [mDNS (Bonjour)](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Wide-area (DNS-SD)](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Environment](https://docs.openclaw.ai/gateway/configuration-reference)
-   [env (inline env vars)](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Env var substitution](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Secrets](https://docs.openclaw.ai/gateway/configuration-reference)
-   [SecretRef](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Supported credential surface](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Secret providers config](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Auth storage](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Logging](https://docs.openclaw.ai/gateway/configuration-reference)
-   [CLI](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Wizard](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Identity](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Bridge (legacy, removed)](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Cron](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Media model template variables](https://docs.openclaw.ai/gateway/configuration-reference)
-   [Config includes ($include)](https://docs.openclaw.ai/gateway/configuration-reference)
...
-   Top-level `bindings[]` entries with `type: "acp"` configure persistent ACP bindings for forum topics (use canonical `chatId:topic:topicId` in `match.peer.id`). Field semantics are shared in [ACP Agents](https://docs.openclaw.ai/tools/acp-agents).
...
-   Top-level `bindings[]` entries with `type: "acp"` configure persistent ACP bindings for channels and threads (use channel/thread id in `match.peer.id`). Field semantics are shared in [ACP Agents](https://docs.openclaw.ai/tools/acp-agents).
...
```
{
  agents: {
    list: [
      { id: "home", default: true, workspace: "~/.claude-lab/silvana-home" },
      { id: "work", workspace: "~/.claude-lab/silvana-work" },
    ],
  },
  bindings: [
...
```
{
  agents: {
    list: [
      {
        id: "personal",
        workspace: "~/.claude-lab/silvana-personal",
        sandbox: { mode: "off" },
      },
    ],
  },
...
```
{
  agents: {
    list: [
      {
        id: "family",
        workspace: "~/.claude-lab/silvana-family",
...
```
{
  agents: {
    list: [
      {
        id: "public",
        workspace: "~/.claude-lab/silvana-public",
...
-   Optional response hardening header:
    -   `gateway.http.securityHeaders.strictTransportSecurity` (set only for HTTPS origins you control; see [Trusted Proxy Auth](https://docs.openclaw.ai/gateway/trusted-proxy-auth))
...
{
  canvasHost: {
    root: "~/.claude-lab/silvana/canvas",
    liveReload: true,
...
Current builds no longer include the TCP bridge. Nodes connect over the Gateway WebSocket. `bridge.*` keys are no longer part of the config schema (validation fails until removed; `openclaw doctor --fix` can strip unknown keys).Legacy bridge config (historical reference)
