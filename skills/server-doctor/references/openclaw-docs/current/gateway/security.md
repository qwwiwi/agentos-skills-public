...
[Skip to main content](https://docs.openclaw.ai/gateway/security)
...
-   [Scope first: personal assistant security model](https://docs.openclaw.ai/gateway/security)
-   [Quick check: openclaw security audit](https://docs.openclaw.ai/gateway/security)
-   [Deployment assumption (important)](https://docs.openclaw.ai/gateway/security)
-   [Practical consequence (operator trust boundary)](https://docs.openclaw.ai/gateway/security)
-   [Personal assistant model (not a multi-tenant bus)](https://docs.openclaw.ai/gateway/security)
-   [Shared Slack workspace: real risk](https://docs.openclaw.ai/gateway/security)
-   [Company-shared agent: acceptable pattern](https://docs.openclaw.ai/gateway/security)
-   [Gateway and node trust concept](https://docs.openclaw.ai/gateway/security)
-   [Trust boundary matrix](https://docs.openclaw.ai/gateway/security)
-   [Not vulnerabilities by design](https://docs.openclaw.ai/gateway/security)
-   [Researcher preflight checklist](https://docs.openclaw.ai/gateway/security)
-   [Hardened baseline in 60 seconds](https://docs.openclaw.ai/gateway/security)
-   [Shared inbox quick rule](https://docs.openclaw.ai/gateway/security)
-   [What the audit checks (high level)](https://docs.openclaw.ai/gateway/security)
-   [Credential storage map](https://docs.openclaw.ai/gateway/security)
-   [Security Audit Checklist](https://docs.openclaw.ai/gateway/security)
-   [Security audit glossary](https://docs.openclaw.ai/gateway/security)
-   [Control UI over HTTP](https://docs.openclaw.ai/gateway/security)
-   [Insecure or dangerous flags summary](https://docs.openclaw.ai/gateway/security)
-   [Reverse Proxy Configuration](https://docs.openclaw.ai/gateway/security)
-   [HSTS and origin notes](https://docs.openclaw.ai/gateway/security)
-   [Local session logs live on disk](https://docs.openclaw.ai/gateway/security)
-   [Node execution (system.run)](https://docs.openclaw.ai/gateway/security)
-   [Dynamic skills (watcher / remote nodes)](https://docs.openclaw.ai/gateway/security)
-   [The Threat Model](https://docs.openclaw.ai/gateway/security)
-   [Core concept: access control before intelligence](https://docs.openclaw.ai/gateway/security)
-   [Command authorization model](https://docs.openclaw.ai/gateway/security)
-   [Control plane tools risk](https://docs.openclaw.ai/gateway/security)
-   [Plugins/extensions](https://docs.openclaw.ai/gateway/security)
-   [DM access model (pairing / allowlist / open / disabled)](https://docs.openclaw.ai/gateway/security)
-   [DM session isolation (multi-user mode)](https://docs.openclaw.ai/gateway/security)
-   [Secure DM mode (recommended)](https://docs.openclaw.ai/gateway/security)
-   [Allowlists (DM + groups) — terminology](https://docs.openclaw.ai/gateway/security)
-   [Prompt injection (what it is, why it matters)](https://docs.openclaw.ai/gateway/security)
-   [Unsafe external content bypass flags](https://docs.openclaw.ai/gateway/security)
-   [Prompt injection does not require public DMs](https://docs.openclaw.ai/gateway/security)
-   [Model strength (security note)](https://docs.openclaw.ai/gateway/security)
-   [Reasoning & verbose output in groups](https://docs.openclaw.ai/gateway/security)
-   [Configuration Hardening (examples)](https://docs.openclaw.ai/gateway/security)
-   [0) File permissions](https://docs.openclaw.ai/gateway/security)
-   [0.4) Network exposure (bind + port + firewall)](https://docs.openclaw.ai/gateway/security)
-   [0.4.1) Docker port publishing + UFW (DOCKER-USER)](https://docs.openclaw.ai/gateway/security)
-   [0.4.2) mDNS/Bonjour discovery (information disclosure)](https://docs.openclaw.ai/gateway/security)
-   [0.5) Lock down the Gateway WebSocket (local auth)](https://docs.openclaw.ai/gateway/security)
-   [0.6) Tailscale Serve identity headers](https://docs.openclaw.ai/gateway/security)
-   [0.6.1) Browser control via node host (recommended)](https://docs.openclaw.ai/gateway/security)
-   [0.7) Secrets on disk (what’s sensitive)](https://docs.openclaw.ai/gateway/security)
-   [0.8) Logs + transcripts (redaction + retention)](https://docs.openclaw.ai/gateway/security)
-   [1) DMs: pairing by default](https://docs.openclaw.ai/gateway/security)
-   [2) Groups: require mention everywhere](https://docs.openclaw.ai/gateway/security)
-   [3\. Separate Numbers](https://docs.openclaw.ai/gateway/security)
-   [4\. Read-Only Mode (Today, via sandbox + tools)](https://docs.openclaw.ai/gateway/security)
-   [5) Secure baseline (copy/paste)](https://docs.openclaw.ai/gateway/security)
-   [Sandboxing (recommended)](https://docs.openclaw.ai/gateway/security)
-   [Sub-agent delegation guardrail](https://docs.openclaw.ai/gateway/security)
-   [Browser control risks](https://docs.openclaw.ai/gateway/security)
-   [Browser SSRF policy (trusted-network default)](https://docs.openclaw.ai/gateway/security)
-   [Per-agent access profiles (multi-agent)](https://docs.openclaw.ai/gateway/security)
-   [Example: full access (no sandbox)](https://docs.openclaw.ai/gateway/security)
-   [Example: read-only tools + read-only workspace](https://docs.openclaw.ai/gateway/security)
-   [Example: no filesystem/shell access (provider messaging allowed)](https://docs.openclaw.ai/gateway/security)
-   [What to Tell Your AI](https://docs.openclaw.ai/gateway/security)
-   [Incident Response](https://docs.openclaw.ai/gateway/security)
-   [Contain](https://docs.openclaw.ai/gateway/security)
-   [Rotate (assume compromise if secrets leaked)](https://docs.openclaw.ai/gateway/security)
-   [Audit](https://docs.openclaw.ai/gateway/security)
-   [Collect for a report](https://docs.openclaw.ai/gateway/security)
-   [Secret Scanning (detect-secrets)](https://docs.openclaw.ai/gateway/security)
-   [If CI fails](https://docs.openclaw.ai/gateway/security)
-   [Reporting Security Issues](https://docs.openclaw.ai/gateway/security)
...
It flags common footguns (Gateway auth exposure, browser control exposure, elevated allowlists, filesystem permissions). OpenClaw is both a product and an experiment: you’re wiring frontier-model behavior into real messaging surfaces and real tools. **There is no “perfectly secure” setup.** The goal is to be deliberate about:
...
4.  Claim is not listed in [Out of Scope](https://github.com/openclaw/openclaw/blob/main/SECURITY.md).
...
-   Detailed deployment guidance is in [Trusted Proxy Auth](https://docs.openclaw.ai/gateway/trusted-proxy-auth).
...
Gateway auth is **required by default**. If no token/password is configured, the Gateway refuses WebSocket connections (fail‑closed). The setup wizard generates a token by default (even for loopback) so local clients must authenticate. Set a token so **all** WS clients must authenticate:
...
[Troubleshooting](https://docs.openclaw.ai/gateway/troubleshooting)[Sandboxing](https://docs.openclaw.ai/gateway/sandboxing)
