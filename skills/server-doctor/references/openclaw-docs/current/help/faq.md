...
[Skip to main content](https://docs.openclaw.ai/help/faq)
...
-   [Table of contents](https://docs.openclaw.ai/help/faq)
-   [First 60 seconds if something’s broken](https://docs.openclaw.ai/help/faq)
-   [Quick start and first-run setup](https://docs.openclaw.ai/help/faq)
-   [Im stuck what’s the fastest way to get unstuck](https://docs.openclaw.ai/help/faq)
-   [What’s the recommended way to install and set up OpenClaw](https://docs.openclaw.ai/help/faq)
-   [How do I open the dashboard after onboarding](https://docs.openclaw.ai/help/faq)
-   [How do I authenticate the dashboard token on localhost vs remote](https://docs.openclaw.ai/help/faq)
-   [What runtime do I need](https://docs.openclaw.ai/help/faq)
-   [Does it run on Raspberry Pi](https://docs.openclaw.ai/help/faq)
-   [Any tips for Raspberry Pi installs](https://docs.openclaw.ai/help/faq)
-   [It is stuck on wake up my friend onboarding will not hatch What now](https://docs.openclaw.ai/help/faq)
-   [Can I migrate my setup to a new machine Mac mini without redoing onboarding](https://docs.openclaw.ai/help/faq)
-   [Where do I see what is new in the latest version](https://docs.openclaw.ai/help/faq)
-   [I can’t access docs.openclaw.ai SSL error What now](https://docs.openclaw.ai/help/faq)
-   [What’s the difference between stable and beta](https://docs.openclaw.ai/help/faq)
-   [How do I install the beta version and what’s the difference between beta and dev](https://docs.openclaw.ai/help/faq)
-   [How long does install and onboarding usually take](https://docs.openclaw.ai/help/faq)
-   [How do I try the latest bits](https://docs.openclaw.ai/help/faq)
-   [Installer stuck How do I get more feedback](https://docs.openclaw.ai/help/faq)
-   [Windows install says git not found or openclaw not recognized](https://docs.openclaw.ai/help/faq)
-   [Windows exec output shows garbled Chinese text what should I do](https://docs.openclaw.ai/help/faq)
-   [The docs didn’t answer my question how do I get a better answer](https://docs.openclaw.ai/help/faq)
-   [How do I install OpenClaw on Linux](https://docs.openclaw.ai/help/faq)
-   [How do I install OpenClaw on a VPS](https://docs.openclaw.ai/help/faq)
-   [Where are the cloudVPS install guides](https://docs.openclaw.ai/help/faq)
-   [Can I ask OpenClaw to update itself](https://docs.openclaw.ai/help/faq)
-   [What does the setup wizard actually do](https://docs.openclaw.ai/help/faq)
-   [Do I need a Claude or OpenAI subscription to run this](https://docs.openclaw.ai/help/faq)
-   [Can I use Claude Max subscription without an API key](https://docs.openclaw.ai/help/faq)
-   [How does Anthropic setuptoken auth work](https://docs.openclaw.ai/help/faq)
-   [Where do I find an Anthropic setuptoken](https://docs.openclaw.ai/help/faq)
-   [Do you support Claude subscription auth (Claude Pro or Max)](https://docs.openclaw.ai/help/faq)
-   [Why am I seeing HTTP 429 ratelimiterror from Anthropic](https://docs.openclaw.ai/help/faq)
-   [Is AWS Bedrock supported](https://docs.openclaw.ai/help/faq)
-   [How does Codex auth work](https://docs.openclaw.ai/help/faq)
-   [Do you support OpenAI subscription auth Codex OAuth](https://docs.openclaw.ai/help/faq)
-   [How do I set up Gemini CLI OAuth](https://docs.openclaw.ai/help/faq)
-   [Is a local model OK for casual chats](https://docs.openclaw.ai/help/faq)
-   [How do I keep hosted model traffic in a specific region](https://docs.openclaw.ai/help/faq)
-   [Do I have to buy a Mac Mini to install this](https://docs.openclaw.ai/help/faq)
-   [Do I need a Mac mini for iMessage support](https://docs.openclaw.ai/help/faq)
-   [If I buy a Mac mini to run OpenClaw can I connect it to my MacBook Pro](https://docs.openclaw.ai/help/faq)
-   [Can I use Bun](https://docs.openclaw.ai/help/faq)
-   [Telegram what goes in allowFrom](https://docs.openclaw.ai/help/faq)
-   [Can multiple people use one WhatsApp number with different OpenClaw instances](https://docs.openclaw.ai/help/faq)
-   [Can I run a fast chat agent and an Opus for coding agent](https://docs.openclaw.ai/help/faq)
-   [Does Homebrew work on Linux](https://docs.openclaw.ai/help/faq)
-   [What’s the difference between the hackable git install and npm install](https://docs.openclaw.ai/help/faq)
-   [Can I switch between npm and git installs later](https://docs.openclaw.ai/help/faq)
-   [Should I run the Gateway on my laptop or a VPS](https://docs.openclaw.ai/help/faq)
-   [How important is it to run OpenClaw on a dedicated machine](https://docs.openclaw.ai/help/faq)
-   [What are the minimum VPS requirements and recommended OS](https://docs.openclaw.ai/help/faq)
-   [Can I run OpenClaw in a VM and what are the requirements](https://docs.openclaw.ai/help/faq)
-   [What is OpenClaw?](https://docs.openclaw.ai/help/faq)
-   [What is OpenClaw in one paragraph](https://docs.openclaw.ai/help/faq)
-   [What’s the value proposition](https://docs.openclaw.ai/help/faq)
-   [I just set it up what should I do first](https://docs.openclaw.ai/help/faq)
-   [What are the top five everyday use cases for OpenClaw](https://docs.openclaw.ai/help/faq)
-   [Can OpenClaw help with lead gen outreach ads and blogs for a SaaS](https://docs.openclaw.ai/help/faq)
-   [What are the advantages vs Claude Code for web development](https://docs.openclaw.ai/help/faq)
-   [Skills and automation](https://docs.openclaw.ai/help/faq)
-   [How do I customize skills without keeping the repo dirty](https://docs.openclaw.ai/help/faq)
-   [Can I load skills from a custom folder](https://docs.openclaw.ai/help/faq)
-   [How can I use different models for different tasks](https://docs.openclaw.ai/help/faq)
-   [The bot freezes while doing heavy work How do I offload that](https://docs.openclaw.ai/help/faq)
-   [How do thread-bound subagent sessions work on Discord](https://docs.openclaw.ai/help/faq)
-   [Cron or reminders do not fire What should I check](https://docs.openclaw.ai/help/faq)
-   [How do I install skills on Linux](https://docs.openclaw.ai/help/faq)
-   [Can OpenClaw run tasks on a schedule or continuously in the background](https://docs.openclaw.ai/help/faq)
-   [Can I run Apple macOS-only skills from Linux?](https://docs.openclaw.ai/help/faq)
-   [Do you have a Notion or HeyGen integration](https://docs.openclaw.ai/help/faq)
-   [How do I use my existing signed-in Chrome with OpenClaw](https://docs.openclaw.ai/help/faq)
-   [Sandboxing and memory](https://docs.openclaw.ai/help/faq)
-   [Is there a dedicated sandboxing doc](https://docs.openclaw.ai/help/faq)
-   [Docker feels limited How do I enable full features](https://docs.openclaw.ai/help/faq)
-   [How do I bind a host folder into the sandbox](https://docs.openclaw.ai/help/faq)
-   [How does memory work](https://docs.openclaw.ai/help/faq)
-   [Memory keeps forgetting things How do I make it stick](https://docs.openclaw.ai/help/faq)
-   [Does semantic memory search require an OpenAI API key](https://docs.openclaw.ai/help/faq)
-   [Does memory persist forever What are the limits](https://docs.openclaw.ai/help/faq)
-   [Where things live on disk](https://docs.openclaw.ai/help/faq)
-   [Is all data used with OpenClaw saved locally](https://docs.openclaw.ai/help/faq)
-   [Where does OpenClaw store its data](https://docs.openclaw.ai/help/faq)
-   [Where should AGENTSmd SOULmd USERmd MEMORYmd live](https://docs.openclaw.ai/help/faq)
-   [What’s the recommended backup strategy](https://docs.openclaw.ai/help/faq)
-   [How do I completely uninstall OpenClaw](https://docs.openclaw.ai/help/faq)
-   [Can agents work outside the workspace](https://docs.openclaw.ai/help/faq)
-   [Im in remote mode where is the session store](https://docs.openclaw.ai/help/faq)
-   [Config basics](https://docs.openclaw.ai/help/faq)
-   [What format is the config Where is it](https://docs.openclaw.ai/help/faq)
-   [I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized](https://docs.openclaw.ai/help/faq)
-   [Why do I need a token on localhost now](https://docs.openclaw.ai/help/faq)
-   [Do I have to restart after changing config](https://docs.openclaw.ai/help/faq)
-   [How do I disable funny CLI taglines](https://docs.openclaw.ai/help/faq)
-   [How do I enable web search and web fetch](https://docs.openclaw.ai/help/faq)
-   [How do I run a central Gateway with specialized workers across devices](https://docs.openclaw.ai/help/faq)
-   [Can the OpenClaw browser run headless](https://docs.openclaw.ai/help/faq)
-   [How do I use Brave for browser control](https://docs.openclaw.ai/help/faq)
-   [Remote gateways and nodes](https://docs.openclaw.ai/help/faq)
-   [How do commands propagate between Telegram the gateway and nodes](https://docs.openclaw.ai/help/faq)
-   [How can my agent access my computer if the Gateway is hosted remotely](https://docs.openclaw.ai/help/faq)
-   [Tailscale is connected but I get no replies What now](https://docs.openclaw.ai/help/faq)
-   [Can two OpenClaw instances talk to each other local VPS](https://docs.openclaw.ai/help/faq)
-   [Do I need separate VPSes for multiple agents](https://docs.openclaw.ai/help/faq)
-   [Is there a benefit to using a node on my personal laptop instead of SSH from a VPS](https://docs.openclaw.ai/help/faq)
-   [Should I install on a second laptop or just add a node](https://docs.openclaw.ai/help/faq)
-   [Do nodes run a gateway service](https://docs.openclaw.ai/help/faq)
-   [Is there an API RPC way to apply config](https://docs.openclaw.ai/help/faq)
-   [configapply wiped my config How do I recover and avoid this](https://docs.openclaw.ai/help/faq)
-   [What’s a minimal sane config for a first install](https://docs.openclaw.ai/help/faq)
-   [How do I set up Tailscale on a VPS and connect from my Mac](https://docs.openclaw.ai/help/faq)
-   [How do I connect a Mac node to a remote Gateway Tailscale Serve](https://docs.openclaw.ai/help/faq)
-   [Env vars and .env loading](https://docs.openclaw.ai/help/faq)
-   [How does OpenClaw load environment variables](https://docs.openclaw.ai/help/faq)
-   [I started the Gateway via the service and my env vars disappeared What now](https://docs.openclaw.ai/help/faq)
-   [I set COPILOTGITHUBTOKEN but models status shows Shell env off Why](https://docs.openclaw.ai/help/faq)
-   [Sessions and multiple chats](https://docs.openclaw.ai/help/faq)
-   [How do I start a fresh conversation](https://docs.openclaw.ai/help/faq)
-   [Do sessions reset automatically if I never send new](https://docs.openclaw.ai/help/faq)
-   [Is there a way to make a team of OpenClaw instances one CEO and many agents](https://docs.openclaw.ai/help/faq)
-   [Why did context get truncated midtask How do I prevent it](https://docs.openclaw.ai/help/faq)
-   [How do I completely reset OpenClaw but keep it installed](https://docs.openclaw.ai/help/faq)
-   [Im getting context too large errors how do I reset or compact](https://docs.openclaw.ai/help/faq)
-   [Why am I seeing “LLM request rejected: messages.content.tool\_use.input field required”?](https://docs.openclaw.ai/help/faq)
-   [Why am I getting heartbeat messages every 30 minutes](https://docs.openclaw.ai/help/faq)
-   [Do I need to add a bot account to a WhatsApp group](https://docs.openclaw.ai/help/faq)
-   [How do I get the JID of a WhatsApp group](https://docs.openclaw.ai/help/faq)
-   [Why doesn’t OpenClaw reply in a group](https://docs.openclaw.ai/help/faq)
-   [Do groups/threads share context with DMs](https://docs.openclaw.ai/help/faq)
-   [How many workspaces and agents can I create](https://docs.openclaw.ai/help/faq)
-   [Can I run multiple bots or chats at the same time Slack and how should I set that up](https://docs.openclaw.ai/help/faq)
-   [Models: defaults, selection, aliases, switching](https://docs.openclaw.ai/help/faq)
-   [What is the default model](https://docs.openclaw.ai/help/faq)
-   [What model do you recommend](https://docs.openclaw.ai/help/faq)
-   [Can I use selfhosted models llamacpp vLLM Ollama](https://docs.openclaw.ai/help/faq)
-   [How do I switch models without wiping my config](https://docs.openclaw.ai/help/faq)
-   [What do OpenClaw, Flawd, and Krill use for models](https://docs.openclaw.ai/help/faq)
-   [How do I switch models on the fly without restarting](https://docs.openclaw.ai/help/faq)
-   [Can I use GPT 5.2 for daily tasks and Codex 5.3 for coding](https://docs.openclaw.ai/help/faq)
-   [Why do I see Model is not allowed and then no reply](https://docs.openclaw.ai/help/faq)
-   [Why do I see Unknown model minimaxMiniMaxM25](https://docs.openclaw.ai/help/faq)
-   [Can I use MiniMax as my default and OpenAI for complex tasks](https://docs.openclaw.ai/help/faq)
-   [Are opus sonnet gpt builtin shortcuts](https://docs.openclaw.ai/help/faq)
-   [How do I defineoverride model shortcuts aliases](https://docs.openclaw.ai/help/faq)
-   [How do I add models from other providers like OpenRouter or ZAI](https://docs.openclaw.ai/help/faq)
-   [Model failover and “All models failed”](https://docs.openclaw.ai/help/faq)
-   [How does failover work](https://docs.openclaw.ai/help/faq)
-   [What does this error mean](https://docs.openclaw.ai/help/faq)
-   [Fix checklist for No credentials found for profile anthropicdefault](https://docs.openclaw.ai/help/faq)
-   [Why did it also try Google Gemini and fail](https://docs.openclaw.ai/help/faq)
-   [Auth profiles: what they are and how to manage them](https://docs.openclaw.ai/help/faq)
-   [What is an auth profile](https://docs.openclaw.ai/help/faq)
-   [What are typical profile IDs](https://docs.openclaw.ai/help/faq)
-   [Can I control which auth profile is tried first](https://docs.openclaw.ai/help/faq)
-   [OAuth vs API key what’s the difference](https://docs.openclaw.ai/help/faq)
-   [Gateway: ports, “already running”, and remote mode](https://docs.openclaw.ai/help/faq)
-   [What port does the Gateway use](https://docs.openclaw.ai/help/faq)
-   [Why does openclaw gateway status say Runtime running but RPC probe failed](https://docs.openclaw.ai/help/faq)
-   [Why does openclaw gateway status show Config cli and Config service different](https://docs.openclaw.ai/help/faq)
-   [What does another gateway instance is already listening mean](https://docs.openclaw.ai/help/faq)
-   [How do I run OpenClaw in remote mode client connects to a Gateway elsewhere](https://docs.openclaw.ai/help/faq)
-   [The Control UI says unauthorized or keeps reconnecting What now](https://docs.openclaw.ai/help/faq)
-   [I set gatewaybind tailnet but it can’t bind nothing listens](https://docs.openclaw.ai/help/faq)
-   [Can I run multiple Gateways on the same host](https://docs.openclaw.ai/help/faq)
-   [What does invalid handshake code 1008 mean](https://docs.openclaw.ai/help/faq)
-   [Logging and debugging](https://docs.openclaw.ai/help/faq)
-   [Where are logs](https://docs.openclaw.ai/help/faq)
-   [How do I start/stop/restart the Gateway service](https://docs.openclaw.ai/help/faq)
-   [I closed my terminal on Windows how do I restart OpenClaw](https://docs.openclaw.ai/help/faq)
-   [The Gateway is up but replies never arrive What should I check](https://docs.openclaw.ai/help/faq)
-   [Disconnected from gateway no reason what now](https://docs.openclaw.ai/help/faq)
-   [Telegram setMyCommands fails What should I check](https://docs.openclaw.ai/help/faq)
-   [TUI shows no output What should I check](https://docs.openclaw.ai/help/faq)
-   [How do I completely stop then start the Gateway](https://docs.openclaw.ai/help/faq)
-   [ELI5 openclaw gateway restart vs openclaw gateway](https://docs.openclaw.ai/help/faq)
-   [What’s the fastest way to get more details when something fails](https://docs.openclaw.ai/help/faq)
-   [Media and attachments](https://docs.openclaw.ai/help/faq)
-   [My skill generated an imagePDF but nothing was sent](https://docs.openclaw.ai/help/faq)
-   [Security and access control](https://docs.openclaw.ai/help/faq)
-   [Is it safe to expose OpenClaw to inbound DMs](https://docs.openclaw.ai/help/faq)
-   [Is prompt injection only a concern for public bots](https://docs.openclaw.ai/help/faq)
-   [Should my bot have its own email GitHub account or phone number](https://docs.openclaw.ai/help/faq)
-   [Can I give it autonomy over my text messages and is that safe](https://docs.openclaw.ai/help/faq)
-   [Can I use cheaper models for personal assistant tasks](https://docs.openclaw.ai/help/faq)
-   [I ran start in Telegram but didn’t get a pairing code](https://docs.openclaw.ai/help/faq)
-   [WhatsApp will it message my contacts How does pairing work](https://docs.openclaw.ai/help/faq)
-   [Chat commands, aborting tasks, and “it won’t stop”](https://docs.openclaw.ai/help/faq)
-   [How do I stop internal system messages from showing in chat](https://docs.openclaw.ai/help/faq)
-   [How do I stopcancel a running task](https://docs.openclaw.ai/help/faq)
-   [How do I send a Discord message from Telegram Crosscontext messaging denied](https://docs.openclaw.ai/help/faq)
-   [Why does it feel like the bot ignores rapidfire messages](https://docs.openclaw.ai/help/faq)
-   [Answer the exact question from the screenshot/chat log](https://docs.openclaw.ai/help/faq)
...
-   \[Quick start and first-run setup\]
    ...
    -   [How do I install OpenClaw on Linux?](https://docs.openclaw.ai/help/faq)
    -   [How do I install OpenClaw on a VPS?](https://docs.openclaw.ai/help/faq)
    -   [Where are the cloud/VPS install guides?](https://docs.openclaw.ai/help/faq)
    -   [Can I ask OpenClaw to update itself?](https://docs.openclaw.ai/help/faq)
    -   [What does the setup wizard actually do?](https://docs.openclaw.ai/help/faq)
    -   [Do I need a Claude or OpenAI subscription to run this?](https://docs.openclaw.ai/help/faq)
    -   [Can I use Claude Max subscription without an API key](https://docs.openclaw.ai/help/faq)
    -   [How does Anthropic “setup-token” auth work?](https://docs.openclaw.ai/help/faq)
    -   [Where do I find an Anthropic setup-token?](https://docs.openclaw.ai/help/faq)
    -   [Do you support Claude subscription auth (Claude Pro or Max)?](https://docs.openclaw.ai/help/faq)
    -   [Why am I seeing `HTTP 429: rate_limit_error` from Anthropic?](https://docs.openclaw.ai/help/faq)
    -   [Is AWS Bedrock supported?](https://docs.openclaw.ai/help/faq)
    -   [How does Codex auth work?](https://docs.openclaw.ai/help/faq)
    -   [Do you support OpenAI subscription auth (Codex OAuth)?](https://docs.openclaw.ai/help/faq)
    -   [How do I set up Gemini CLI OAuth](https://docs.openclaw.ai/help/faq)
...
-   [Where things live on disk](https://docs.openclaw.ai/help/faq)
    -   [Is all data used with OpenClaw saved locally?](https://docs.openclaw.ai/help/faq)
    -   [Where does OpenClaw store its data?](https://docs.openclaw.ai/help/faq)
    -   [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](https://docs.openclaw.ai/help/faq)
    -   [What’s the recommended backup strategy?](https://docs.openclaw.ai/help/faq)
    -   [How do I completely uninstall OpenClaw?](https://docs.openclaw.ai/help/faq)
    -   [Can agents work outside the workspace?](https://docs.openclaw.ai/help/faq)
    -   [I’m in remote mode - where is the session store?](https://docs.openclaw.ai/help/faq)
-   [Config basics](https://docs.openclaw.ai/help/faq)
    -   [What format is the config? Where is it?](https://docs.openclaw.ai/help/faq)
    -   [I set `gateway.bind: "lan"` (or `"tailnet"`) and now nothing listens / the UI says unauthorized](https://docs.openclaw.ai/help/faq)
    -   [Why do I need a token on localhost now?](https://docs.openclaw.ai/help/faq)
    -   [Do I have to restart after changing config?](https://docs.openclaw.ai/help/faq)
    -   [How do I disable funny CLI taglines?](https://docs.openclaw.ai/help/faq)
    -   [How do I enable web search (and web fetch)?](https://docs.openclaw.ai/help/faq)
    -   [config.apply wiped my config. How do I recover and avoid this?](https://docs.openclaw.ai/help/faq)
    -   [How do I run a central Gateway with specialized workers across devices?](https://docs.openclaw.ai/help/faq)
    -   [Can the OpenClaw browser run headless?](https://docs.openclaw.ai/help/faq)
    -   [How do I use Brave for browser control?](https://docs.openclaw.ai/help/faq)
-   [Remote gateways and nodes](https://docs.openclaw.ai/help/faq)
...
-   [Env vars and .env loading](https://docs.openclaw.ai/help/faq)
    -   [How does OpenClaw load environment variables?](https://docs.openclaw.ai/help/faq)
    -   [“I started the Gateway via the service and my env vars disappeared.” What now?](https://docs.openclaw.ai/help/faq)
    -   [I set `COPILOT_GITHUB_TOKEN`, but models status shows “Shell env: off.” Why?](https://docs.openclaw.ai/help/faq)
-   [Sessions and multiple chats](https://docs.openclaw.ai/help/faq)
    -   [How do I start a fresh conversation?](https://docs.openclaw.ai/help/faq)
    -   [Do sessions reset automatically if I never send `/new`?](https://docs.openclaw.ai/help/faq)
    -   [Is there a way to make a team of OpenClaw instances one CEO and many agents](https://docs.openclaw.ai/help/faq)
    -   [Why did context get truncated mid-task? How do I prevent it?](https://docs.openclaw.ai/help/faq)
    -   [How do I completely reset OpenClaw but keep it installed?](https://docs.openclaw.ai/help/faq)
    -   [I’m getting “context too large” errors - how do I reset or compact?](https://docs.openclaw.ai/help/faq)
    -   [Why am I seeing “LLM request rejected: messages.content.tool\_use.input field required”?](https://docs.openclaw.ai/help/faq)
    -   [Why am I getting heartbeat messages every 30 minutes?](https://docs.openclaw.ai/help/faq)
    -   [Do I need to add a “bot account” to a WhatsApp group?](https://docs.openclaw.ai/help/faq)
    -   [How do I get the JID of a WhatsApp group?](https://docs.openclaw.ai/help/faq)
...
-   [Models: defaults, selection, aliases, switching](https://docs.openclaw.ai/help/faq)
    ...
    -   [What model do you recommend?](https://docs.openclaw.ai/help/faq)
    -   [How do I switch models without wiping my config?](https://docs.openclaw.ai/help/faq)
    -   [Can I use self-hosted models (llama.cpp, vLLM, Ollama)?](https://docs.openclaw.ai/help/faq)
    -   [What do OpenClaw, Flawd, and Krill use for models?](https://docs.openclaw.ai/help/faq)
    -   [How do I switch models on the fly (without restarting)?](https://docs.openclaw.ai/help/faq)
    -   [Can I use GPT 5.2 for daily tasks and Codex 5.3 for coding](https://docs.openclaw.ai/help/faq)
    -   [Why do I see “Model … is not allowed” and then no reply?](https://docs.openclaw.ai/help/faq)
    -   [Why do I see “Unknown model: minimax/MiniMax-M2.5”?](https://docs.openclaw.ai/help/faq)
    -   [Can I use MiniMax as my default and OpenAI for complex tasks?](https://docs.openclaw.ai/help/faq)
    -   [Are opus / sonnet / gpt built-in shortcuts?](https://docs.openclaw.ai/help/faq)
    -   [How do I define/override model shortcuts (aliases)?](https://docs.openclaw.ai/help/faq)
    -   [How do I add models from other providers like OpenRouter or Z.AI?](https://docs.openclaw.ai/help/faq)
-   [Model failover and “All models failed”](https://docs.openclaw.ai/help/faq)
    -   [How does failover work?](https://docs.openclaw.ai/help/faq)
    -   [What does this error mean?](https://docs.openclaw.ai/help/faq)
    -   [Fix checklist for `No credentials found for profile "anthropic:default"`](https://docs.openclaw.ai/help/faq)
    -   [Why did it also try Google Gemini and fail?](https://docs.openclaw.ai/help/faq)
-   [Auth profiles: what they are and how to manage them](https://docs.openclaw.ai/help/faq)
    -   [What is an auth profile?](https://docs.openclaw.ai/help/faq)
    -   [What are typical profile IDs?](https://docs.openclaw.ai/help/faq)
...
-   [Gateway: ports, “already running”, and remote mode](https://docs.openclaw.ai/help/faq)
    ...
    -   [How do I run OpenClaw in remote mode (client connects to a Gateway elsewhere)?](https://docs.openclaw.ai/help/faq)
    -   [The Control UI says “unauthorized” (or keeps reconnecting). What now?](https://docs.openclaw.ai/help/faq)
    -   [I set `gateway.bind: "tailnet"` but it can’t bind / nothing listens](https://docs.openclaw.ai/help/faq)
    -   [Can I run multiple Gateways on the same host?](https://docs.openclaw.ai/help/faq)
    -   [What does “invalid handshake” / code 1008 mean?](https://docs.openclaw.ai/help/faq)
-   [Logging and debugging](https://docs.openclaw.ai/help/faq)
    -   [Where are logs?](https://docs.openclaw.ai/help/faq)
    ...
    -   [What’s the fastest way to get more details when something fails?](https://docs.openclaw.ai/help/faq)
-   [Media and attachments](https://docs.openclaw.ai/help/faq)
    -   [My skill generated an image/PDF, but nothing was sent](https://docs.openclaw.ai/help/faq)
-   [Security and access control](https://docs.openclaw.ai/help/faq)
    -   [Is it safe to expose OpenClaw to inbound DMs?](https://docs.openclaw.ai/help/faq)
    -   [Is prompt injection only a concern for public bots?](https://docs.openclaw.ai/help/faq)
    -   [Should my bot have its own email GitHub account or phone number](https://docs.openclaw.ai/help/faq)
...
-   [Chat commands, aborting tasks, and “it won’t stop”](https://docs.openclaw.ai/help/faq)
    -   [How do I stop internal system messages from showing in chat](https://docs.openclaw.ai/help/faq)
    -   [How do I stop/cancel a running task?](https://docs.openclaw.ai/help/faq)
    -   [How do I send a Discord message from Telegram? (“Cross-context messaging denied”)](https://docs.openclaw.ai/help/faq)
    -   [Why does it feel like the bot “ignores” rapid-fire messages?](https://docs.openclaw.ai/help/faq)
...
4.  **Deep probes**
    ...
    Runs gateway health checks + provider probes (requires a reachable gateway). See [Health](https://docs.openclaw.ai/gateway/health).
...
3.  Copy your workspace (default: `~/.claude-lab/silvana`).
...
If it hangs, use [Installer stuck](https://docs.openclaw.ai/help/faq) and the fast debug loop in [Im stuck](https://docs.openclaw.ai/help/faq).
...
`channels.telegram.allowFrom` is **the human sender’s Telegram user ID** (numeric). It is not the bot username. The setup wizard accepts `@username` input and resolves it to a numeric ID, but OpenClaw authorization uses numeric IDs only. Safer (no third-party bot):
...
See [/channels/telegram](https://docs.openclaw.ai/channels/telegram).
...
Yes. Install the other flavor, then run Doctor so the gateway service points at the new entrypoint. This **does not delete your data** - it only changes the OpenClaw code install. Your state (`~/.openclaw`) and workspace (`~/.claude-lab/silvana`) stay untouched. From npm → git:
...
Doctor detects a gateway service entrypoint mismatch and offers to rewrite the service config to match the current install (use `--repair` in automation). Backup tips: see [Backup strategy](https://docs.openclaw.ai/help/faq).
...
Set `agents.defaults.sandbox.docker.binds` to `["host:path:mode"]` (e.g., `"/home/user/src:/src:ro"`). Global + per-agent binds merge; per-agent binds are ignored when `scope: "shared"`. Use `:ro` for anything sensitive and remember binds bypass the sandbox filesystem walls. See [Sandboxing](https://docs.openclaw.ai/gateway/sandboxing) and [Sandbox vs Tool Policy vs Elevated](https://docs.openclaw.ai/gateway/sandbox-vs-tool-policy-vs-elevated) for examples and safety notes.
...
Legacy single-agent path: `~/.openclaw/agent/*` (migrated by `openclaw doctor`). Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.claude-lab/silvana`).
...
Default workspace is `~/.claude-lab/silvana`, configurable via:
...
If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.claude-lab/silvana`).
...
`web_fetch` works without an API key. `web_search` requires a key for your selected provider (Brave, Gemini, Grok, Kimi, or Perplexity). **Recommended:** run `openclaw configure --section web` and choose a provider. Environment alternatives:
...
Set `browser.executablePath` to your Brave binary (or any Chromium-based browser) and restart the Gateway. See the full config examples in [Browser](https://docs.openclaw.ai/tools/browser).
...
SSH is fine for ad-hoc shell access, but nodes are simpler for ongoing agent workflows and device automation. Docs: [Nodes](https://docs.openclaw.ai/nodes), [Nodes CLI](https://docs.openclaw.ai/cli/nodes), [Browser](https://docs.openclaw.ai/tools/browser).
...
-   The setup wizard also offers **Reset** if it sees an existing config. See [Wizard](https://docs.openclaw.ai/start/wizard).
...
Docs: [Multi-Agent Routing](https://docs.openclaw.ai/concepts/multi-agent), [Slack](https://docs.openclaw.ai/channels/slack), [Browser](https://docs.openclaw.ai/tools/browser), [Nodes](https://docs.openclaw.ai/nodes).
...
If it is still noisy, check the session settings in the Control UI and set verbose to **inherit**. Also confirm you are not using a bot profile with `verboseDefault` set to `on` in config. Docs: [Thinking and verbose](https://docs.openclaw.ai/tools/thinking), [Security](https://docs.openclaw.ai/gateway/security).
...
[Troubleshooting](https://docs.openclaw.ai/help/troubleshooting)[OpenClaw Lore](https://docs.openclaw.ai/start/lore)
