...
[Skip to main content](https://docs.openclaw.ai/help/testing)
...
-   [Quick start](https://docs.openclaw.ai/help/testing)
-   [Test suites (what runs where)](https://docs.openclaw.ai/help/testing)
-   [Unit / integration (default)](https://docs.openclaw.ai/help/testing)
-   [E2E (gateway smoke)](https://docs.openclaw.ai/help/testing)
-   [E2E: OpenShell backend smoke](https://docs.openclaw.ai/help/testing)
-   [Live (real providers + real models)](https://docs.openclaw.ai/help/testing)
-   [Which suite should I run?](https://docs.openclaw.ai/help/testing)
-   [Live: Android node capability sweep](https://docs.openclaw.ai/help/testing)
-   [Live: model smoke (profile keys)](https://docs.openclaw.ai/help/testing)
-   [Layer 1: Direct model completion (no gateway)](https://docs.openclaw.ai/help/testing)
-   [Layer 2: Gateway + dev agent smoke (what “@openclaw” actually does)](https://docs.openclaw.ai/help/testing)
-   [Live: Anthropic setup-token smoke](https://docs.openclaw.ai/help/testing)
-   [Live: CLI backend smoke (Claude Code CLI or other local CLIs)](https://docs.openclaw.ai/help/testing)
-   [Recommended live recipes](https://docs.openclaw.ai/help/testing)
-   [Live: model matrix (what we cover)](https://docs.openclaw.ai/help/testing)
-   [Modern smoke set (tool calling + image)](https://docs.openclaw.ai/help/testing)
-   [Baseline: tool calling (Read + optional Exec)](https://docs.openclaw.ai/help/testing)
-   [Vision: image send (attachment → multimodal message)](https://docs.openclaw.ai/help/testing)
-   [Aggregators / alternate gateways](https://docs.openclaw.ai/help/testing)
-   [Credentials (never commit)](https://docs.openclaw.ai/help/testing)
-   [Deepgram live (audio transcription)](https://docs.openclaw.ai/help/testing)
-   [BytePlus coding plan live](https://docs.openclaw.ai/help/testing)
-   [Docker runners (optional “works in Linux” checks)](https://docs.openclaw.ai/help/testing)
-   [Docs sanity](https://docs.openclaw.ai/help/testing)
-   [Offline regression (CI-safe)](https://docs.openclaw.ai/help/testing)
-   [Agent reliability evals (skills)](https://docs.openclaw.ai/help/testing)
-   [Adding regressions (guidance)](https://docs.openclaw.ai/help/testing)
...
-   `OPENCLAW_WORKSPACE_DIR=...` (default: `~/.claude-lab/silvana`) mounted to `/home/node/.openclaw/workspace`
...
[Debugging](https://docs.openclaw.ai/help/debugging)[Scripts](https://docs.openclaw.ai/help/scripts)
