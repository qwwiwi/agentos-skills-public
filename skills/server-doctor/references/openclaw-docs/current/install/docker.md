...
[Skip to main content](https://docs.openclaw.ai/install/docker)
...
-   [Docker (optional)](https://docs.openclaw.ai/install/docker)
-   [Is Docker right for me?](https://docs.openclaw.ai/install/docker)
-   [Requirements](https://docs.openclaw.ai/install/docker)
-   [Containerized Gateway (Docker Compose)](https://docs.openclaw.ai/install/docker)
-   [Quick start (recommended)](https://docs.openclaw.ai/install/docker)
-   [Enable agent sandbox for Docker gateway (opt-in)](https://docs.openclaw.ai/install/docker)
-   [Automation/CI (non-interactive, no TTY noise)](https://docs.openclaw.ai/install/docker)
-   [Shared-network security note (CLI + gateway)](https://docs.openclaw.ai/install/docker)
-   [Use a remote image (skip local build)](https://docs.openclaw.ai/install/docker)
-   [Base image metadata](https://docs.openclaw.ai/install/docker)
-   [Shell Helpers (optional)](https://docs.openclaw.ai/install/docker)
-   [Manual flow (compose)](https://docs.openclaw.ai/install/docker)
-   [Control UI token + pairing (Docker)](https://docs.openclaw.ai/install/docker)
-   [Extra mounts (optional)](https://docs.openclaw.ai/install/docker)
-   [Persist the entire container home (optional)](https://docs.openclaw.ai/install/docker)
-   [Install extra apt packages (optional)](https://docs.openclaw.ai/install/docker)
-   [Pre-install extension dependencies (optional)](https://docs.openclaw.ai/install/docker)
-   [Power-user / full-featured container (opt-in)](https://docs.openclaw.ai/install/docker)
-   [Permissions + EACCES](https://docs.openclaw.ai/install/docker)
-   [Faster rebuilds (recommended)](https://docs.openclaw.ai/install/docker)
-   [Channel setup (optional)](https://docs.openclaw.ai/install/docker)
-   [OpenAI Codex OAuth (headless Docker)](https://docs.openclaw.ai/install/docker)
-   [Health checks](https://docs.openclaw.ai/install/docker)
-   [E2E smoke test (Docker)](https://docs.openclaw.ai/install/docker)
-   [QR import smoke test (Docker)](https://docs.openclaw.ai/install/docker)
-   [LAN vs loopback (Docker Compose)](https://docs.openclaw.ai/install/docker)
-   [Notes](https://docs.openclaw.ai/install/docker)
-   [Storage model](https://docs.openclaw.ai/install/docker)
-   [Agent Sandbox (host gateway + Docker tools)](https://docs.openclaw.ai/install/docker)
-   [What it does](https://docs.openclaw.ai/install/docker)
-   [Per-agent sandbox profiles (multi-agent)](https://docs.openclaw.ai/install/docker)
-   [Default behavior](https://docs.openclaw.ai/install/docker)
-   [Enable sandboxing](https://docs.openclaw.ai/install/docker)
-   [Build the default sandbox image](https://docs.openclaw.ai/install/docker)
-   [Sandbox common image (optional)](https://docs.openclaw.ai/install/docker)
-   [Sandbox browser image](https://docs.openclaw.ai/install/docker)
-   [Custom sandbox image](https://docs.openclaw.ai/install/docker)
-   [Tool policy (allow/deny)](https://docs.openclaw.ai/install/docker)
-   [Pruning strategy](https://docs.openclaw.ai/install/docker)
-   [Security notes](https://docs.openclaw.ai/install/docker)
-   [Troubleshooting](https://docs.openclaw.ai/install/docker)
...
-   If running on a VPS/public host, review [Security hardening for network exposure](https://docs.openclaw.ai/gateway/security), especially Docker `DOCKER-USER` firewall policy.
...
[Installer Internals](https://docs.openclaw.ai/install/installer)[Podman](https://docs.openclaw.ai/install/podman)
