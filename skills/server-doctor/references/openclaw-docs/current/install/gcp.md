...
[Skip to main content](https://docs.openclaw.ai/install/gcp)
...
-   [OpenClaw on GCP Compute Engine (Docker, Production VPS Guide)](https://docs.openclaw.ai/install/gcp)
-   [Goal](https://docs.openclaw.ai/install/gcp)
-   [What are we doing (simple terms)?](https://docs.openclaw.ai/install/gcp)
-   [Quick path (experienced operators)](https://docs.openclaw.ai/install/gcp)
-   [What you need](https://docs.openclaw.ai/install/gcp)
-   [1) Install gcloud CLI (or use Console)](https://docs.openclaw.ai/install/gcp)
-   [2) Create a GCP project](https://docs.openclaw.ai/install/gcp)
-   [3) Create the VM](https://docs.openclaw.ai/install/gcp)
-   [4) SSH into the VM](https://docs.openclaw.ai/install/gcp)
-   [5) Install Docker (on the VM)](https://docs.openclaw.ai/install/gcp)
-   [6) Clone the OpenClaw repository](https://docs.openclaw.ai/install/gcp)
-   [7) Create persistent host directories](https://docs.openclaw.ai/install/gcp)
-   [8) Configure environment variables](https://docs.openclaw.ai/install/gcp)
-   [9) Docker Compose configuration](https://docs.openclaw.ai/install/gcp)
-   [10) Shared Docker VM runtime steps](https://docs.openclaw.ai/install/gcp)
-   [11) GCP-specific launch notes](https://docs.openclaw.ai/install/gcp)
-   [12) Access from your laptop](https://docs.openclaw.ai/install/gcp)
-   [Troubleshooting](https://docs.openclaw.ai/install/gcp)
-   [Service accounts (security best practice)](https://docs.openclaw.ai/install/gcp)
-   [Next steps](https://docs.openclaw.ai/install/gcp)
...
-   Persist `~/.openclaw` + `~/.claude-lab/silvana` on the host (survives restarts/rebuilds)
...
Need the shared persistence and update reference again? See [Docker VM Runtime](https://docs.openclaw.ai/install/docker-vm-runtime) and [Docker VM Runtime updates](https://docs.openclaw.ai/install/docker-vm-runtime).
...
[Hetzner](https://docs.openclaw.ai/install/hetzner)[macOS VMs](https://docs.openclaw.ai/install/macos-vm)
