...
-   Copy your **workspace** (`~/.claude-lab/silvana/` by default) — this includes your agent files (memory, prompts, etc.).
...
-   `~/.claude-lab/silvana/` (recommended workspace)
...
-   your workspace (default `~/.claude-lab/silvana/`)
