...
[Skip to main content](https://docs.openclaw.ai/reference/AGENTS.default)
...
-   [AGENTS.md — OpenClaw Personal Assistant (default)](https://docs.openclaw.ai/reference/AGENTS.default)
-   [First run (recommended)](https://docs.openclaw.ai/reference/AGENTS.default)
-   [Safety defaults](https://docs.openclaw.ai/reference/AGENTS.default)
-   [Session start (required)](https://docs.openclaw.ai/reference/AGENTS.default)
-   [Soul (required)](https://docs.openclaw.ai/reference/AGENTS.default)
-   [Shared spaces (recommended)](https://docs.openclaw.ai/reference/AGENTS.default)
-   [Memory system (recommended)](https://docs.openclaw.ai/reference/AGENTS.default)
-   [Tools & skills](https://docs.openclaw.ai/reference/AGENTS.default)
-   [Backup tip (recommended)](https://docs.openclaw.ai/reference/AGENTS.default)
-   [What OpenClaw Does](https://docs.openclaw.ai/reference/AGENTS.default)
-   [Core Skills (enable in Settings → Skills)](https://docs.openclaw.ai/reference/AGENTS.default)
-   [Usage Notes](https://docs.openclaw.ai/reference/AGENTS.default)
...
OpenClaw uses a dedicated workspace directory for the agent. Default: `~/.claude-lab/silvana` (configurable via `agents.defaults.workspace`).
