...
<!-- Title: Setup Wizard Reference - OpenClaw -->

[Skip to main content](https://docs.openclaw.ai/reference/wizard)
...
-   [Setup Wizard Reference](https://docs.openclaw.ai/reference/wizard)
-   [Flow details (local mode)](https://docs.openclaw.ai/reference/wizard)
-   [Non-interactive mode](https://docs.openclaw.ai/reference/wizard)
-   [Add agent (non-interactive)](https://docs.openclaw.ai/reference/wizard)
-   [Gateway wizard RPC](https://docs.openclaw.ai/reference/wizard)
-   [Signal setup (signal-cli)](https://docs.openclaw.ai/reference/wizard)
-   [What the wizard writes](https://docs.openclaw.ai/reference/wizard)
-   [Related docs](https://docs.openclaw.ai/reference/wizard)
...
This is the full reference for the `openclaw onboard` CLI wizard. For a high-level overview, see [Setup Wizard](https://docs.openclaw.ai/start/wizard).
...
-   Default `~/.claude-lab/silvana` (configurable).
...
Provider-specific command examples live in [CLI Automation](https://docs.openclaw.ai/start/wizard-cli-automation). Use this reference page for flag semantics and step ordering.
...
-   `session.dmScope` (behavior details: [CLI Setup Reference](https://docs.openclaw.ai/start/wizard-cli-reference))
...
`openclaw agents add` writes `agents.list[]` and optional `bindings`. WhatsApp credentials go under `~/.openclaw/credentials/whatsapp/<accountId>/`. Sessions are stored under `~/.openclaw/agents/<agentId>/sessions/`. Some channels are delivered as plugins. When you pick one during setup, the wizard will prompt to install it (npm or a local path) before it can be configured.
...
-   Wizard overview: [Setup Wizard](https://docs.openclaw.ai/start/wizard)
...
[USER](https://docs.openclaw.ai/reference/templates/USER)[Token Use and Costs](https://docs.openclaw.ai/reference/token-use)
