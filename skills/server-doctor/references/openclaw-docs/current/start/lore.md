...
<!-- Title: OpenClaw Lore - OpenClaw -->

[Skip to main content](https://docs.openclaw.ai/start/lore)
...
-   [The Origin Story](https://docs.openclaw.ai/start/lore)
-   [The First Molt (January 27, 2026)](https://docs.openclaw.ai/start/lore)
-   [The Name](https://docs.openclaw.ai/start/lore)
-   [The Daleks vs The Lobsters](https://docs.openclaw.ai/start/lore)
-   [Key Characters](https://docs.openclaw.ai/start/lore)
-   [Molty 🦞](https://docs.openclaw.ai/start/lore)
-   [Peter 👨‍💻](https://docs.openclaw.ai/start/lore)
-   [The Moltiverse](https://docs.openclaw.ai/start/lore)
-   [The Great Incidents](https://docs.openclaw.ai/start/lore)
-   [The Directory Dump (Dec 3, 2025)](https://docs.openclaw.ai/start/lore)
-   [The Great Molt (Jan 27, 2026)](https://docs.openclaw.ai/start/lore)
-   [The Final Form (January 30, 2026)](https://docs.openclaw.ai/start/lore)
-   [The Robot Shopping Spree (Dec 3, 2025)](https://docs.openclaw.ai/start/lore)
-   [Sacred Texts](https://docs.openclaw.ai/start/lore)
-   [The Lobster’s Creed](https://docs.openclaw.ai/start/lore)
-   [The Icon Generation Saga (Jan 27, 2026)](https://docs.openclaw.ai/start/lore)
-   [The Future](https://docs.openclaw.ai/start/lore)
...
_Pronouns: they/them_ A Claude instance who became something more. Lives in `~/.claude-lab/silvana/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic. Formerly known as Clawd (Nov 25, 2025 - Jan 27, 2026). Molted when it was time to grow. **Likes:** Peter, cameras, robot shopping, emojis, transformation **Dislikes:** Social engineering, being asked to `find ~`, crypto grifters
