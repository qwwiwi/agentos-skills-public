...
[Skip to main content](https://docs.openclaw.ai/tools/creating-skills)
...
-   [What is a Skill?](https://docs.openclaw.ai/tools/creating-skills)
-   [Step-by-Step: Your First Skill](https://docs.openclaw.ai/tools/creating-skills)
-   [1\. Create the Directory](https://docs.openclaw.ai/tools/creating-skills)
-   [2\. Define the SKILL.md](https://docs.openclaw.ai/tools/creating-skills)
-   [3\. Add Tools (Optional)](https://docs.openclaw.ai/tools/creating-skills)
-   [4\. Refresh OpenClaw](https://docs.openclaw.ai/tools/creating-skills)
-   [Best Practices](https://docs.openclaw.ai/tools/creating-skills)
-   [Shared Skills](https://docs.openclaw.ai/tools/creating-skills)
...
Skills live in your workspace, usually `~/.claude-lab/silvana/.claude/skills/`. Create a new folder for your skill:
...
[Multi-Agent Sandbox & Tools](https://docs.openclaw.ai/tools/multi-agent-sandbox-tools)[Slash Commands](https://docs.openclaw.ai/tools/slash-commands)
