<!-- Source: https://docs.openclaw.ai/zh-CN/gateway/configuration-examples -->
<!-- Title: 配置示例 - OpenClaw -->

[跳转到主要内容](https://docs.openclaw.ai/zh-CN/gateway/configuration-examples)
...
-   [配置示例](https://docs.openclaw.ai/zh-CN/gateway/configuration-examples)
-   [快速开始](https://docs.openclaw.ai/zh-CN/gateway/configuration-examples)
-   [绝对最小配置](https://docs.openclaw.ai/zh-CN/gateway/configuration-examples)
-   [推荐的入门配置](https://docs.openclaw.ai/zh-CN/gateway/configuration-examples)
-   [扩展示例（主要选项）](https://docs.openclaw.ai/zh-CN/gateway/configuration-examples)
-   [常见模式](https://docs.openclaw.ai/zh-CN/gateway/configuration-examples)
-   [多平台设置](https://docs.openclaw.ai/zh-CN/gateway/configuration-examples)
-   [OAuth 带 API 密钥回退](https://docs.openclaw.ai/zh-CN/gateway/configuration-examples)
-   [Anthropic 订阅 + API 密钥，MiniMax 回退](https://docs.openclaw.ai/zh-CN/gateway/configuration-examples)
-   [工作机器人（受限访问）](https://docs.openclaw.ai/zh-CN/gateway/configuration-examples)
-   [仅本地模型](https://docs.openclaw.ai/zh-CN/gateway/configuration-examples)
-   [提示](https://docs.openclaw.ai/zh-CN/gateway/configuration-examples)
...
以下示例与当前配置模式一致。有关详尽的参考和每个字段的说明，请参阅[配置](https://docs.openclaw.ai/gateway/configuration)。
...
-   参阅[提供商](https://docs.openclaw.ai/channels/whatsapp)和[故障排除](https://docs.openclaw.ai/gateway/troubleshooting)了解更深入的设置说明。

[配置](https://docs.openclaw.ai/zh-CN/gateway/configuration)[认证](https://docs.openclaw.ai/zh-CN/gateway/authentication)
