<!-- Source: https://docs.openclaw.ai/zh-CN/help/testing -->
<!-- Title: 测试 - OpenClaw -->

[跳转到主要内容](https://docs.openclaw.ai/zh-CN/help/testing)
...
-   [测试](https://docs.openclaw.ai/zh-CN/help/testing)
-   [快速开始](https://docs.openclaw.ai/zh-CN/help/testing)
-   [测试套件（在哪里运行什么）](https://docs.openclaw.ai/zh-CN/help/testing)
-   [单元/集成测试（默认）](https://docs.openclaw.ai/zh-CN/help/testing)
-   [端到端测试（Gateway 网关冒烟测试）](https://docs.openclaw.ai/zh-CN/help/testing)
-   [实时测试（真实提供商 + 真实模型）](https://docs.openclaw.ai/zh-CN/help/testing)
-   [我应该运行哪个套件？](https://docs.openclaw.ai/zh-CN/help/testing)
-   [实时测试：模型冒烟测试（配置文件密钥）](https://docs.openclaw.ai/zh-CN/help/testing)
-   [第一层：直接模型补全（无 Gateway 网关）](https://docs.openclaw.ai/zh-CN/help/testing)
-   [第二层：Gateway 网关 + 开发智能体冒烟测试（“@openclaw”实际做的事）](https://docs.openclaw.ai/zh-CN/help/testing)
-   [实时测试：Anthropic 设置令牌冒烟测试](https://docs.openclaw.ai/zh-CN/help/testing)
-   [实时测试：CLI 后端冒烟测试（Claude Code CLI 或其他本地 CLI）](https://docs.openclaw.ai/zh-CN/help/testing)
-   [推荐的实时测试配方](https://docs.openclaw.ai/zh-CN/help/testing)
-   [实时测试：模型矩阵（我们覆盖什么）](https://docs.openclaw.ai/zh-CN/help/testing)
-   [现代冒烟测试集（工具调用 + 图像）](https://docs.openclaw.ai/zh-CN/help/testing)
-   [基线：工具调用（Read + 可选 Exec）](https://docs.openclaw.ai/zh-CN/help/testing)
-   [视觉：图像发送（附件 → 多模态消息）](https://docs.openclaw.ai/zh-CN/help/testing)
-   [聚合器/替代 Gateway 网关](https://docs.openclaw.ai/zh-CN/help/testing)
-   [凭证（绝不提交）](https://docs.openclaw.ai/zh-CN/help/testing)
-   [Deepgram 实时测试（音频转录）](https://docs.openclaw.ai/zh-CN/help/testing)
-   [Docker 运行器（可选的”在 Linux 中工作”检查）](https://docs.openclaw.ai/zh-CN/help/testing)
-   [文档完整性检查](https://docs.openclaw.ai/zh-CN/help/testing)
-   [离线回归测试（CI 安全）](https://docs.openclaw.ai/zh-CN/help/testing)
-   [智能体可靠性评估（Skills）](https://docs.openclaw.ai/zh-CN/help/testing)
-   [添加回归测试（指导）](https://docs.openclaw.ai/zh-CN/help/testing)
...
运行带工具 + 图像的 Gateway 网关冒烟测试： `OPENCLAW_LIVE_GATEWAY_MODELS="openai/gpt-5.2,openai-codex/gpt-5.2,anthropic/claude-opus-4-5,google/gemini-3-pro-preview,google/gemini-3-flash-preview,google-antigravity/claude-opus-4-6-thinking,google-antigravity/gemini-3-flash,zai/glm-4.7,minimax/minimax-m2.1" pnpm test:live src/gateway/gateway-models.profiles.live.test.ts`
...
-   `OPENCLAW_WORKSPACE_DIR=...`（默认：`~/.claude-lab/silvana`）挂载到 `/home/node/.openclaw/workspace`
...
对于 Skills 仍然缺少的内容（参见 [Skills](https://docs.openclaw.ai/tools/skills)）：
...
[调试](https://docs.openclaw.ai/zh-CN/help/debugging)[脚本](https://docs.openclaw.ai/zh-CN/help/scripts)
