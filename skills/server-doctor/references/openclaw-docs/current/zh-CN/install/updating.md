...
[跳转到主要内容](https://docs.openclaw.ai/zh-CN/install/updating)
...
-   [推荐：重新运行网站安装程序（原地升级）](https://docs.openclaw.ai/zh-CN/install/updating)
-   [更新之前](https://docs.openclaw.ai/zh-CN/install/updating)
-   [更新（全局安装）](https://docs.openclaw.ai/zh-CN/install/updating)
-   [更新（openclaw update）](https://docs.openclaw.ai/zh-CN/install/updating)
-   [更新（控制 UI / RPC）](https://docs.openclaw.ai/zh-CN/install/updating)
-   [更新（从源码）](https://docs.openclaw.ai/zh-CN/install/updating)
-   [始终运行：openclaw doctor](https://docs.openclaw.ai/zh-CN/install/updating)
-   [启动/停止/重启 Gateway 网关](https://docs.openclaw.ai/zh-CN/install/updating)
-   [回滚/固定（当出问题时）](https://docs.openclaw.ai/zh-CN/install/updating)
-   [固定（全局安装）](https://docs.openclaw.ai/zh-CN/install/updating)
-   [按日期固定（源码）](https://docs.openclaw.ai/zh-CN/install/updating)
-   [如果你卡住了](https://docs.openclaw.ai/zh-CN/install/updating)
...
我们**不**推荐将 Bun 用于 Gateway 网关运行时（WhatsApp/Telegram 有 bug）。 切换更新渠道（git + npm 安装）：
...
使用 `--tag <dist-tag|version>` 进行一次性安装指定标签/版本。 渠道语义和发布说明参见[开发渠道](https://docs.openclaw.ai/install/development-channels)。 注意：在 npm 安装上，Gateway 网关在启动时会记录更新提示（检查当前渠道标签）。通过 `update.checkOnStart: false` 禁用。 然后：
...
Doctor 是”安全更新”命令。它故意很无聊：修复 + 迁移 + 警告。 注意：如果你是**源码安装**（git checkout），`openclaw doctor` 会提供先运行 `openclaw update`。 它通常做的事情：
...
详情：[Doctor](https://docs.openclaw.ai/gateway/doctor)
...
运行手册 + 确切的服务标签：[Gateway 网关运行手册](https://docs.openclaw.ai/gateway)
...
提示：要查看当前发布的版本，运行 `npm view openclaw version`。 然后重启 + 重新运行 doctor：
...
-   查看：[故障排除](https://docs.openclaw.ai/gateway/troubleshooting)
