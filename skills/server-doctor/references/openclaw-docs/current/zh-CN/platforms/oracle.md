<!-- Source: https://docs.openclaw.ai/zh-CN/platforms/oracle -->
<!-- Title: Oracle Cloud - OpenClaw -->

[跳转到主要内容](https://docs.openclaw.ai/zh-CN/platforms/oracle)
...
-   [在 Oracle Cloud（OCI）上运行 OpenClaw](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [目标](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [成本比较（2026）](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [先决条件](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [1) 创建 OCI 实例](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [2) 连接并更新](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [3) 配置用户和主机名](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [4) 安装 Tailscale](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [5) 安装 OpenClaw](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [6) 配置 Gateway 网关（loopback + 令牌认证）并启用 Tailscale Serve](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [7) 验证](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [8) 锁定 VCN 安全](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [访问控制 UI](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [安全：VCN + Tailscale（推荐基线）](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [已经受保护的内容](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [仍然推荐](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [验证安全态势](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [备用方案：SSH 隧道](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [故障排除](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [实例创建失败（“Out of capacity”）](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [Tailscale 无法连接](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [Gateway 网关无法启动](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [无法访问控制 UI](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [ARM 二进制文件问题](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [持久化](https://docs.openclaw.ai/zh-CN/platforms/oracle)
-   [另请参阅](https://docs.openclaw.ai/zh-CN/platforms/oracle)
...
在 Oracle Cloud 的 **Always Free** ARM 层上运行持久化的 OpenClaw Gateway 网关。 Oracle 的免费层非常适合 OpenClaw（特别是如果你已经有 OCI 账户），但有一些权衡：
...
这会启用 Tailscale SSH，所以你可以从 tailnet 上的任何设备通过 `ssh openclaw` 连接——不需要公网 IP。 验证：
...
将 `<tailnet-name>` 替换为你的 tailnet 名称（在 `tailscale status` 中可见）。 不需要 SSH 隧道。Tailscale 提供：
...
通过锁定 VCN（仅开放 UDP 41641）并将 Gateway 网关绑定到 loopback，你获得了强大的纵深防御：公共流量在网络边缘被阻止，管理访问通过你的 tailnet 进行。 此设置通常消除了纯粹为了阻止互联网范围的 SSH 暴力破解而需要额外的基于主机的防火墙规则的_需求_——但你仍应保持操作系统更新，运行 `openclaw security audit`，并验证你没有意外地在公共接口上监听。
...
-   `~/.openclaw/` — 配置、凭证、会话数据
-   `~/.claude-lab/silvana/` — 工作区（SOUL.md、记忆、产物）
...
-   [Gateway 网关远程访问](https://docs.openclaw.ai/gateway/remote) — 其他远程访问模式
-   [Tailscale 集成](https://docs.openclaw.ai/gateway/tailscale) — 完整的 Tailscale 文档
-   [Gateway 网关配置](https://docs.openclaw.ai/gateway/configuration) — 所有配置选项
-   [DigitalOcean 指南](https://docs.openclaw.ai/platforms/digitalocean) — 如果你想要付费 + 更容易注册
-   [Hetzner 指南](https://docs.openclaw.ai/install/hetzner) — 基于 Docker 的替代方案

[DigitalOcean](https://docs.openclaw.ai/zh-CN/platforms/digitalocean)[Raspberry Pi](https://docs.openclaw.ai/zh-CN/platforms/raspberry-pi)
